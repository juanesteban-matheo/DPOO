...
public class PanelDetallesRestaurante extends JPanel
{
    ...
    // Adición para poder actualizar el panel más fácilmente
    ...
    public PanelDetallesRestaurante( )
    {
    	...
    	chkVisitado = new JCheckBox("No", false);
    ...
    private void actualizarRestaurante( String nombre, int calificacion, boolean visitado )
    {
    	...
    	this.nombreRestaurante = nombre; // Actualiza el nombre de la clase
    	labCalificacion.setIcon( buscarIconoCalificacion(calificacion) );
    	chkVisitado.setText("Sí");
    ...
    public void actualizarRestaurante( Restaurante r )
    {
        ...
        this.nombreRestaurante = r.getNombre();
        }
