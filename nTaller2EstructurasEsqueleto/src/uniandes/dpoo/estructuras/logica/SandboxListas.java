...
public class SandboxListas
{
    ...
    {
        List<Integer> newList = new ArrayList<Integer>(listaEnteros);
        return newList;
    }
    ...
    {
    	List<String> newList = new LinkedList<String>(listaCadenas);
        return newList;
    }
    ...
    public int[] getEnterosComoArreglo( )
    {
        ...
        for (int i = 0; i < listaEnteros.size(); i++) {
        	int value = listaEnteros.get(i);
        	arregloEnteros[i] = value;
        	}
    ...
    public void eliminarCadena( String cadena )
    {
    	for (int i = 0; i < listaCadenas.size(); i++) {
    		String word = listaCadenas.get(i);
    		if (word.equals(cadena)) {
    			listaEnteros.remove(i);
    		}
    	}
    }
    ...
    public void volverPositivos( )
    {
    	...
    	for (int i = 0; i < listaEnteros.size(); i++) {
    		positiveList.add(i, Math.abs(listaEnteros.get(i)) );
    	}
    	listaEnteros = positiveList;
    }
    ...
    public void organizarEnteros( )
    {
    	...
    	for (int i = 0; i < size; i++) {
    		reversedList.add(size - i, null);
    	}
    	listaEnteros = reversedList;
    }
