...
public class Restaurante
{
     ...
     * 
     * @param pedidoNuevo El pedido a iniciar, el cual contiene el nombre y la dirección del cliente
     ...
     */
    public void iniciarPedido( Pedido pedidoNuevo ) throws YaHayUnPedidoEnCursoException
    {
        if( pedidoEnCurso != null )
            throw new YaHayUnPedidoEnCursoException( pedidoEnCurso.getNombreCliente( ), pedidoNuevo.getNombreCliente() );
  
        pedidoEnCurso = pedidoNuevo;
    }
