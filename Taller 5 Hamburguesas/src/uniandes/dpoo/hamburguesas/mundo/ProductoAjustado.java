...
public class ProductoAjustado implements Producto
{
    ...
    /***
     * Registra un ingrediente para ser añadido al producto base
     * @param ingrediente
     */
    ...
    /***
     * Registra un ingrediente para ser elimidado del producto base
     * @param ingrediente
     */
    ...
    public int getPrecio( )
    {
        ...
        precioAjustado += productoBase.getPrecio();
        
        if (!agregados.isEmpty()) { 						// Es decir, si la lista NO está vacía
        	for (Ingrediente ingrediente : agregados) {
            	precioAjustado += ingrediente.getCostoAdicional();
            }
        }
        if (!eliminados.isEmpty()) { 						// Es decir, si la lista NO está vacía
